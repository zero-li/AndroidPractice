  ...
  public void onIpChangeProgress(OnIpChangeProgressParam prm) {
    ...
    public void onMediaEvent(OnMediaEventParam prm) {
        if (getClass() == Endpoint.class)
            pjsua2JNI.Endpoint_onMediaEvent(swigCPtr, this, OnMediaEventParam.getCPtr(prm), prm);
        else
            pjsua2JNI.Endpoint_onMediaEventSwigExplicitEndpoint(swigCPtr, this, OnMediaEventParam.getCPtr(prm), prm);
    }
