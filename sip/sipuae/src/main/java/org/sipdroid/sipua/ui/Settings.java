...
public class Settings extends PreferenceActivity implements OnSharedPreferenceChangeListener, OnClickListener {
    ...
    public static final String DEFAULT_USERNAME = "1001";
    public static final String DEFAULT_PASSWORD = "1234554321";
    public static final String DEFAULT_SERVER = "123.57.11.182";
